...
from Backend.views import UserView, UserHealthInfoList, UserHealthInfoAPIView, login_view, PostUserHealthInfo, UpdateUserInfo
...
urlpatterns = [
    ...
    path('<str:username>/', UserHealthInfoAPIView.as_view(), name='get_user_data'),
]
